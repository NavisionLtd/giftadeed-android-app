package giftadeed.kshantechsoft.com.giftadeed.CookiesPolicy;
...
public class CookiesPolicy extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = inflater.inflate(R.layout.fragment_cookies_policy, container, false);
        fragmgr = getFragmentManager();
        TaggedneedsActivity.updateTitle(getResources().getString(R.string.cookies_heading));
        TaggedneedsActivity.fragname = CookiesPolicy.newInstance(0);
