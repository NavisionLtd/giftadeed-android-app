...
////////////////////////////////////////////////////////////////////
//                                                               //
//     Shows end user licence aggrement of app                  //
/////////////////////////////////////////////////////////////////
public class EnduserAggrement extends Fragment {
    ...
    public static EnduserAggrement newInstance(int sectionNumber) {
        EnduserAggrement fragment = new EnduserAggrement();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview=inflater.inflate(R.layout.fragment_enduser_aggrment, container, false);
        fragmgr = getFragmentManager();
        TaggedneedsActivity.fragname= EnduserAggrement.newInstance(0);
        TaggedneedsActivity.updateTitle(getResources().getString(R.string.end_user_heading));
