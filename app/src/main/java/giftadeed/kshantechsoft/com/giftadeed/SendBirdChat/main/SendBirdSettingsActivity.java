...
import giftadeed.kshantechsoft.com.giftadeed.SendBirdChat.utils.ImageUtils;
...
public class SendBirdSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //+ ProfileUrl
        String profileUrl = PreferenceUtils.getProfileUrl(SendBirdSettingsActivity.this);
        ...
        final String nickname = PreferenceUtils.getNickname(SendBirdSettingsActivity.this);
        ...
        //+ Notifications
        boolean notifications = PreferenceUtils.getNotifications(SendBirdSettingsActivity.this);
        mSwitchNotifications.setChecked(notifications);
        mSwitchNotificationsShowPreviews.setChecked(PreferenceUtils.getNotificationsShowPreviews(SendBirdSettingsActivity.this));
        checkNotifications(notifications);

        boolean doNotDisturb = PreferenceUtils.getNotificationsDoNotDisturb(SendBirdSettingsActivity.this);
                ...
                if (isChecked) {
                    PushUtils.registerPushTokenForCurrentUser(SendBirdSettingsActivity.this, new SendBird.RegisterPushTokenWithStatusHandler() {
                        ...
                        public void onRegistered(SendBird.PushTokenRegistrationStatus pushTokenRegistrationStatus, SendBirdException e) {
                            ...
                            PreferenceUtils.setNotifications(SendBirdSettingsActivity.this, isChecked);
                            checkNotifications(isChecked);
                        }
                    });
                } else {
        ...
        mSwitchNotificationsShowPreviews.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                PreferenceUtils.setNotificationsShowPreviews(SendBirdSettingsActivity.this, isChecked);
            }
        });
        ...
        SendBird.getDoNotDisturb(new SendBird.GetDoNotDisturbHandler() {
            ...
            public void onResult(boolean isDoNotDisturbOn, int startHour, int startMin, int endHour, int endMin, String timezone, SendBirdException e) {
                ...
                PreferenceUtils.setNotificationsDoNotDisturbFrom(SendBirdSettingsActivity.this, String.valueOf(fromMillis));
                ...
                PreferenceUtils.setNotificationsDoNotDisturbTo(SendBirdSettingsActivity.this, String.valueOf(toMillis));
        ...
        mCheckBoxGroupChannelDistinct.setChecked(PreferenceUtils.getGroupChannelDistinct(SendBirdSettingsActivity.this));

        mCheckBoxGroupChannelDistinct.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                PreferenceUtils.setGroupChannelDistinct(SendBirdSettingsActivity.this, isChecked);
            }
        });
        //- Group Channel Distinct
    }
    ...
    private void saveDoNotDisturb(final boolean doNotDisturb) {
        String doNotDisturbFrom = PreferenceUtils.getNotificationsDoNotDisturbFrom(SendBirdSettingsActivity.this);
        String doNotDisturbTo = PreferenceUtils.getNotificationsDoNotDisturbTo(SendBirdSettingsActivity.this);
            ...
            SendBird.setDoNotDisturb(doNotDisturb, startHour, startMin, endHour, endMin, TimeZone.getDefault().getID(), new SendBird.SetDoNotDisturbHandler() {
                ...
                public void onResult(SendBirdException e) {
                    if (e != null) {
                        ...
                        PreferenceUtils.setNotificationsDoNotDisturb(SendBirdSettingsActivity.this, !doNotDisturb);
                        checkDoNotDisturb(!doNotDisturb);
                        return;
                    }
    ...
    private void setDoNotDisturbTime(final boolean from, final TextView textView) {
        ...
        new TimePickerDialog(SendBirdSettingsActivity.this, new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker timePicker, int hour, int min) {
                ...
                if (from) {
                    if (!String.valueOf(millis).equals(PreferenceUtils.getNotificationsDoNotDisturbFrom(SendBirdSettingsActivity.this))) {
                        PreferenceUtils.setNotificationsDoNotDisturbFrom(SendBirdSettingsActivity.this, String.valueOf(millis));
                        saveDoNotDisturb(true);
                    }
                } else {
                    if (!String.valueOf(millis).equals(PreferenceUtils.getNotificationsDoNotDisturbTo(SendBirdSettingsActivity.this))) {
                        PreferenceUtils.setNotificationsDoNotDisturbTo(SendBirdSettingsActivity.this, String.valueOf(millis));
                        saveDoNotDisturb(true);
                    }
                }
    ...
    private void updateCurrentUserProfileImage(final File profileImage, final ImageView imageView) {
        ...
        SendBird.updateCurrentUserInfoWithProfileImage(nickname, profileImage, new SendBird.UserInfoUpdateHandler() {
            ...
            public void onUpdated(SendBirdException e) {
                ...
                try {
                    PreferenceUtils.setProfileUrl(SendBirdSettingsActivity.this, SendBird.getCurrentUser().getProfileUrl());
    ...
    private void updateCurrentUserInfo(final String userNickname) {
        final String profileUrl = PreferenceUtils.getProfileUrl(SendBirdSettingsActivity.this);
        SendBird.updateCurrentUserInfo(userNickname, profileUrl, new SendBird.UserInfoUpdateHandler() {
            ...
            public void onUpdated(SendBirdException e) {
                ...
                PreferenceUtils.setNickname(SendBirdSettingsActivity.this, userNickname);
            }
        });
    }
