...
GifViewTag extends View {
    ...
    public GifViewTag(Context context) {
        super(context);
        init(context);
    }

    public GifViewTag(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public GifViewTag(Context context, AttributeSet attrs, int defStyleAttr) {
